...
data = open("http://sunearth.gsfc.nasa.gov/spaceweather/FlexApp/bin-debug/config/visualizations.xml?foolcache=7F6D5F14-8302-22EF-EB21-0CA58754DB50").read
...
EO
  ...
  category["media"].each do |media|
    ...
    [asset setValuesForKeysWithDictionary:[NSDictionary dictionaryWithObjectsAndKeys:
         ...
         @"tt://<FILENAME OF THUMB>", @"localSource",
         category, @"category",
