 ...
 */
  ...
  [category setValue:@"The Sun" forKey:@"headline"];
    ...
    [asset setValuesForKeysWithDictionary:[NSDictionary dictionaryWithObjectsAndKeys:
		 ...
		 @"304.png", @"infoThumbnail",
         @"", @"localSource",
         category, @"category",
         @"",	@"link",
         @"",	@"linkTitle",
         @"The AIA 304 analyzes solar prominences. A prominence is a large, bright feature extending outward from the Sun's surface, often in a loop shape. Prominences are anchored to the Sun's surface in the photosphere, and extend outwards into the Sun's corona. While the corona consists of extremely hot ionized gases, known as plasma, which do not emit much visible light, prominences contain much cooler plasma, similar in composition to that of the chromosphere. A prominence forms in about a day, and stable prominences may persist in the corona for several months. Some prominences break apart and give rise to coronal mass ejections. Scientists are currently researching how and why prominences are formed.", @"text", 
        nil
       ]];
    ...
    [asset setValuesForKeysWithDictionary:[NSDictionary dictionaryWithObjectsAndKeys:
		 ...
		 @"171-+-HMI.png", @"infoThumbnail",
         @"", @"localSource",
         category, @"category",
         @"",	@"link",
         @"",	@"linkTitle",
         @"This composite image shows the HMI magnetic field in blue and orange (indicating opposite polarity) with the AIA 171 channel in extreme ultraviolet superimposed over it. The juxtaposition is especially effective at showing how the arcs that we observe in UV light emerge from regions of strong magnetic field.", @"text", 
        nil
       ]];
    asset = [NSEntityDescription insertNewObjectForEntityForName:@"Asset" inManagedObjectContext:context];
    ...
    [asset setValuesForKeysWithDictionary:[NSDictionary dictionaryWithObjectsAndKeys:
		 ...
		 @"HMI.png", @"infoThumbnail",
         @"", @"localSource",
         category, @"category",
         @"",	@"link",
         @"",	@"linkTitle",
         @"HMI is an instrument designed to study oscillations and the magnetic field at the solar surface, or photosphere. HMI is one of three instruments on the Solar Dynamics Observatory; together, the suite of instruments observes the Sun nearly continuously and takes a terabyte of data a day. HMI observes the full solar disk at 6173 Å with a resolution of 1 arcsecond. HMI is a successor to the Michelson Doppler Imager on the Solar and Heliospheric Observatory.  The magnetogram or magnetic image of the Sun shows the magnetic field in the solar photosphere. The black and white shading indicates opposite polarities. Using technology similar to that of a radar gun, it maps the charge and direction of movement towards or away from the viewer of plasma around the active regions.", @"text", 
        nil
       ]];
    asset = [NSEntityDescription insertNewObjectForEntityForName:@"Asset" inManagedObjectContext:context];
    ...
    [asset setValuesForKeysWithDictionary:[NSDictionary dictionaryWithObjectsAndKeys:
		 ...
		 @"Intensitygram.png", @"infoThumbnail",
         @"", @"localSource",
         category, @"category",
         @"",	@"link",
         @"",	@"linkTitle",
         @"The HMI Intensitygram SDO mission produces black and white images of any visible sunspots. ", @"text", 
        nil
       ]];
    asset = [NSEntityDescription insertNewObjectForEntityForName:@"Asset" inManagedObjectContext:context];
    ...
    [asset setValuesForKeysWithDictionary:[NSDictionary dictionaryWithObjectsAndKeys:
		 ...
		 @"Solar-Surface.png", @"infoThumbnail",
         @"", @"localSource",
         category, @"category",
         @"",	@"link",
         @"",	@"linkTitle",
         @"A close-up image of the solar surface obtained by the Hinode Solar Optical telescope (SOT). The image changes as the scientific research goals change on a daily/weekly basis. The image may show solar granulation regions, or close-ups of a sunspot or other active region.", @"text", 
        nil
       ]];
    asset = [NSEntityDescription insertNewObjectForEntityForName:@"Asset" inManagedObjectContext:context];
